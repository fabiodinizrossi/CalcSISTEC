...
- [ ] A caixa amarela de confirmação de preservação de campus ausente sai da tela; salvar deixa de exigir esse clique.
...
| --- | --- | --- | --- |
| AFE-01 | P1: Salvar sem o clique extra de confirmação | Design | Pending |
