...
- **Botão do cabeçalho a partir de 992px (DS-05, revisto 2026-09-20):** a primeira versão mantinha o botão para recolher o menu persistente; após o teste em tela grande, o menu virou barra lateral fixa e o botão foi removido nessa faixa (AD-005, ver `validation.md`).
