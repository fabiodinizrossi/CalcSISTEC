...
- **Estado**: **concluída**, Execute inline (sem `tasks.md` formal, conforme a tabela de rastreabilidade de `spec.md`). Os dois bugs confirmados com o export real (`Downloads/08agosto`, 11 campi — 14.022 matrículas no painel novo contra 16.750 no legado) foram corrigidos e as duas regras ficaram cobertas por teste. Branch `migracao-dash-gov-br`, sem push/merge/deploy. Commits: `9411302`, `8df7552`, `182375b` (o `59b6444` veio junto, sobre o corpus sintético).
